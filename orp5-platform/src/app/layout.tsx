  ...
  return (
    <html lang="en" suppressHydrationWarning>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-MQS4FMZW');
            `,
          }}
        />
      </head>
      ...
      >
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-MQS4FMZW"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1197749550095310&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <Script
